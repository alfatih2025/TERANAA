      ...
      <div className={`bg-gradient-to-br ${currentMeta.accent} p-6 text-white`}>
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          ...
          <div className="rounded-2xl bg-white/12 p-4 backdrop-blur-sm">
            <div className="flex items-center gap-2 text-white/80">
              <Waves size={16} />
              <span className="text-xs uppercase tracking-wide">Curah hujan</span>
            </div>
            <p className="mt-3 text-2xl font-semibold">{data.current.rain_amount} mm</p>
          </div>
        </div>
      </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3 text-sm">
                    ...
                    <div className="rounded-xl bg-white light-card p-3 dark:bg-gray-900 dark:border-gray-800">
                      <p className="text-xs text-slate-600 dark:text-slate-300">Curah hujan</p>
                      <p className="mt-1 font-semibold text-slate-900 dark:text-slate-100">{item.rain_amount} mm</p>
                    </div>
                  </div>
                </motion.div>
              );
