const { createUserRef, updateUserRef, deleteUserRef, getCurrentUserRef, listAllUsersRef, createProjectRef, updateProjectRef, deleteProjectRef, getProjectRef, listProjectsRef, createTaskRef, updateTaskRef, deleteTaskRef, getTaskRef, listTasksRef, addMemberRef, updateMemberRoleRef, removeMemberRef, getProjectMemberRef, listProjectMembersRef, connectorConfig } = require('../index.cjs.js');
...
exports.useAddMember = function useAddMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
...
exports.useRemoveMember = function useRemoveMember(dcOrOptions, options) {
  const { dc: dcInstance, vars: inputOpts } = validateArgs(connectorConfig, dcOrOptions, options);
  function refFactory(vars) {
