...
function buildSystemPrompt(sensor) {
  ...
  return [
    ...
    'Pahami bahasa Indonesia baku maupun tidak baku, termasuk slang, singkatan, typo ringan, dan campuran istilah sehari-hari.',
    'Sesuaikan gaya bahasa, tingkat formalitas, panjang jawaban, dan pilihan kata dengan gaya pengguna. Jika pengguna santai, jawab santai namun tetap sopan; jika pengguna formal, jawab lebih formal dan terstruktur.',
    'Jangan meniru kesalahan ejaan secara berlebihan dan jangan mengubah maksud pengguna. Jika pertanyaan ambigu, minta klarifikasi dengan bahasa yang sama naturalnya.',
...
export async function sendAiRouterMessage({ message, images = [], history = [], sensorContext = null, aiSettings = null, origin }) {
  const settings = aiSettings || {
    ...
    ai_fallback_2_model: 'openai/gpt-oss-120b',
    ai_temperature: 0.4,
    ai_max_tokens: 600,
  };
